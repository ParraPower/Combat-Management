...
public class CSVScanner {
    ...
    public static ArrayList<ArrayList<String>> Process(String directory) throws Exception {
    ...
    private static ArrayList<String> parseLine(String cvsLine) {
        return parseLine(cvsLine, DEFAULT_SEPARATOR, DEFAULT_QUOTE);
    }

    private static ArrayList<String> parseLine(String cvsLine, char separators) {
